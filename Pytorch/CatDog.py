...
plt.ion()
train_cat = 'D:/dogs-vs-cats-redux-kernels-edition/train/train_cat'
print('total training cat images:', len(os.listdir(train_cat)))

train_dog = 'D:/dogs-vs-cats-redux-kernels-edition/train/train_dog'
print('total training dog images:', len(os.listdir(train_dog)))

val_cat = 'D:/dogs-vs-cats-redux-kernels-edition/test/test'
print('total validation cat images:', len(os.listdir(val_cat)))

val_dog = 'D:/dogs-vs-cats-redux-kernels-edition/test/test'
